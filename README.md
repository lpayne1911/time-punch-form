...
- **[`playbook.html`](playbook.html)** — First $10K Swing Trading Playbook. A
  styled reference page distilled from a swing-trading video, with three
  interactive tools: a position-size calculator, a "2x S&P" leader check, and a
  pre-trade checklist that tells you to skip the trade when any box is
  unconfirmed.
